...
public interface DataSourceRegistry {
     ...
     */
    @NonNull CompletableFuture<Void> register(@NonNull DataSource dataSource);
     ...
     */
    @NonNull CompletableFuture<Optional<DataSource>> getDataSource(@NonNull String dataSourceName);
     ...
     */
    @NonNull CompletableFuture<Void> unregister(@NonNull DataSource dataSource);
     ...
     */
    @NonNull CompletableFuture<Void> unregister(@NonNull String dataSourceName);
